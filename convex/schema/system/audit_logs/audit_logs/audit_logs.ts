// convex/schema/system/audit_logs/audit_logs/audit_logs.ts
// Table definitions for audit_logs module
...
export const auditLogsTable = defineTable({
  ...
  publicId: v.string(),
  // Exemption: audit logs track actors via userId instead of ownerId (cross-tenant)
