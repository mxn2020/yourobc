// convex/schema/software/yourobc/employeeCommissions/employeeCommissionRules.ts
/**
 ...
 *
 * @module convex/schema/software/yourobc/employeeCommissions/employeeCommissionRules
 */
...
import { commissionTierValidator, serviceTypeValidator } from './validators'
...
export const employeeCommissionRulesTable = defineTable({
  ...
  tiers: v.optional(v.array(commissionTierValidator)), // for tiered type

  // Service Type Filter (optional)
  serviceTypes: v.optional(v.array(serviceTypeValidator)),
