    ...
    await ctx.db.insert('auditLogs', {
      ...
      metadata: {
        ...
        oldValues: {
          ...
          extendedMetadata: profile.extendedMetadata ?? null,
        },
        newValues: {
          name: trimmedUpdates.name ?? null,
          avatar: trimmedUpdates.avatar ?? null,
          bio: trimmedUpdates.bio ?? null,
          extendedMetadata: trimmedUpdates.extendedMetadata ?? null,
        },
      },
      createdAt: now,
...
export const updateProfileMetadata = mutation({
  ...
  handler: async (ctx, { targetUserId, extendedMetadata, operation = 'merge' }) => {
    ...
    await ctx.db.insert('auditLogs', {
      ...
      metadata: {
        operation,
        oldValues: targetProfile.extendedMetadata ?? null,
        newValues: extendedMetadata ?? null,
      },
      createdAt: now,
      createdBy: currentUser._id,
      updatedAt: now,
