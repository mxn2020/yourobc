...
export function generateApiKey(): { key: string; prefix: string; hash: string } {
  ...
  const secret = generateRandomString(INTEGRATIONS_CONFIG.API_KEY_LENGTH);
...
export function generateAccessToken(): string {
  return 'at_' + generateRandomString(INTEGRATIONS_CONFIG.OAUTH_TOKEN_LENGTH);
}
...
export function generateRefreshToken(): string {
  return 'rt_' + generateRandomString(INTEGRATIONS_CONFIG.OAUTH_TOKEN_LENGTH);
}
