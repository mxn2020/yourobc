...
// Constants values arrays (for easy iteration/validation)
export const MILESTONE_VALUES = {
  status: Object.values(MILESTONE_CONSTANTS.STATUS),
  priority: Object.values(MILESTONE_CONSTANTS.PRIORITY),
} as const;
