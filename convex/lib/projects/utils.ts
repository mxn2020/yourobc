 ...
 */
export function trimProjectData<T extends Partial<CreateProjectData | UpdateProjectData>>(
  data: T
): T {
...
export function buildSearchableText(
  ...
  if (data.extendedMetadata?.client) parts.push(data.extendedMetadata.client);
