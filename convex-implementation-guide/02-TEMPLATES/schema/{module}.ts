...
export const {module}Table = defineTable({
  // Main display field (choose ONE based on entity type)
  name: v.string(),          // For: users, products, categories, organizations
  // OR: title: v.string(),     // For: posts, projects, tasks, invoices, documents
  // OR: displayName: v.string(), // For: ambiguous cases
