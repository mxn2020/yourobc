...
export const createQuote = mutation({
  args: {
    data: v.object({
      ...
      origin: quotesFields.address,
      destination: quotesFields.address,
      dimensions: quotesFields.dimensions,
      description: v.string(),
      specialInstructions: v.optional(v.string()),
      deadline: v.number(),
      validUntil: v.number(),
      baseCost: v.optional(quotesFields.currencyAmount),
      markup: v.optional(v.number()),
      totalPrice: v.optional(quotesFields.currencyAmount),
...
export const updateQuote = mutation({
  args: {
    ...
    updates: v.object({
      ...
      inquirySourceId: v.optional(v.id('inquirySources')),
      origin: v.optional(quotesFields.address),
      destination: v.optional(quotesFields.address),
