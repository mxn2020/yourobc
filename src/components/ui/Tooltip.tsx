...
import { forwardRef, useState, useCallback, useRef, useEffect, cloneElement, ReactElement, memo } from 'react'
...
interface ChildElementHandlers {
...
export const Tooltip = memo(forwardRef<ElementRef<'div'>, TooltipProps>(
  ({ 
    content, 
    children, 
    position = 'top', 
