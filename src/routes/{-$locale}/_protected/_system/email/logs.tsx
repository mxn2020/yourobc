// routes/{-$locale}/_protected/_system/email/logs.tsx

import { createFileRoute, redirect } from '@tanstack/react-router'
import { EmailLogsPage, emailService } from '@/features/system/email'
...
export const Route = createFileRoute('/{-$locale}/_protected/_system/email/logs')({
