// routes/{-$locale}/_protected/_system/projects/index.tsx

import { createFileRoute } from '@tanstack/react-router'
import { ProjectsPage, projectsService } from '@/features/system/projects'
import { api } from '@/convex/_generated/api'
import { Loading } from '@/components/ui'
import { defaultLocale } from '@/features/system/i18n'
import { createI18nSeo } from '@/utils/seo'

export const Route = createFileRoute('/{-$locale}/_protected/_system/projects/')({
      ...
      try {
        ...
        if (convexClient) {
          const [projects, stats] = await Promise.all([
            convexClient.query(api.lib.system.projects.queries.getProjects, {
              options: { limit: 100 }
            }),
            convexClient.query(api.lib.system.projects.queries.getProjectStats, {})
          ])
