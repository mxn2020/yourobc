// routes/{-$locale}/_protected/_system/projects/new.tsx

import { createFileRoute } from '@tanstack/react-router'
import { CreateProjectPage } from '@/features/system/projects'
import { Loading } from '@/components/ui'
import { defaultLocale } from '@/features/system/i18n'
import { createI18nSeo } from '@/utils/seo'

export const Route = createFileRoute('/{-$locale}/_protected/_system/projects/new')({
