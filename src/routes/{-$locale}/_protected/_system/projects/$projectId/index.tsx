// routes/{-$locale}/_protected/_system/projects/$projectId/index.tsx

import { createFileRoute } from '@tanstack/react-router'
import { ProjectDetailsPage } from '@/features/system/projects'
...
export const Route = createFileRoute('/{-$locale}/_protected/_system/projects/$projectId/')({
      ...
      try {
        ...
        if (convexClient) {
          ...
          const [project, members] = await Promise.all([
            convexClient.query(api.lib.system.projects.queries.getProject, {
              projectId
            }),
            convexClient.query(api.lib.system.projects.queries.getProjectMembers, {
              projectId
            })
          ])
