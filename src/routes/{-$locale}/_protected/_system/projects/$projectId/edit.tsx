// routes/{-$locale}/_protected/_system/projects/$projectId/edit.tsx

import { createFileRoute } from '@tanstack/react-router'
import { EditProjectPage } from '@/features/system/projects/pages/EditProjectPage'
...
export const Route = createFileRoute('/{-$locale}/_protected/_system/projects/$projectId/edit')({
    ...
    if (typeof window === 'undefined') {
      try {
        ...
        if (convexClient) {
          ...
          const project = await convexClient.query(api.lib.system.projects.queries.getProject, {
            projectId
          })
