// routes/{-$locale}/_protected/_system/ai-testing.tsx

import { createFileRoute } from '@tanstack/react-router'
import { AITestingPage } from '@/features/system/ai-testing'
import { Loading } from '@/components/ui'
import { defaultLocale } from '@/features/system/i18n'
import { createI18nSeo } from '@/utils/seo'

export const Route = createFileRoute('/{-$locale}/_protected/_system/ai-testing')({
  loader: async () => {
