// routes/{-$locale}/_protected/_boilerplate/settings.tsx
...
export const Route = createFileRoute('/{-$locale}/_protected/_boilerplate/settings')({
  loader: async ({ context }) => {
    ...
    const userSettingsQueryOptions = convexQuery(api.lib.boilerplate.user_settings.queries.getUserSettings, {})
    ...
    if (isServer) {
      try {
        ...
        if (convexClient) {
          // Fetch user settings
          const settings = await convexClient.query(api.lib.boilerplate.user_settings.queries.getUserSettings, {})
