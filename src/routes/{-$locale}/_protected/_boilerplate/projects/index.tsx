// routes/{-$locale}/_protected/_boilerplate/projects/index.tsx

import { createFileRoute } from '@tanstack/react-router'
import { ProjectsPage, projectsService } from '@/features/boilerplate/projects'
import { api } from '@/convex/_generated/api'
import { Loading } from '@/components/ui'
import { defaultLocale } from '@/features/boilerplate/i18n'
import { createI18nSeo } from '@/utils/seo'

export const Route = createFileRoute('/{-$locale}/_protected/_boilerplate/projects/')({
