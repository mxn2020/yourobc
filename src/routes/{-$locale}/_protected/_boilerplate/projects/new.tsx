// routes/{-$locale}/_protected/_boilerplate/projects/new.tsx

import { createFileRoute } from '@tanstack/react-router'
import { CreateProjectPage } from '@/features/boilerplate/projects'
import { Loading } from '@/components/ui'
import { defaultLocale } from '@/features/boilerplate/i18n'
import { createI18nSeo } from '@/utils/seo'

export const Route = createFileRoute('/{-$locale}/_protected/_boilerplate/projects/new')({
