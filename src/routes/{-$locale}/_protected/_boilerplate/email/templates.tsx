// routes/{-$locale}/_protected/_boilerplate/email/templates.tsx

import { createFileRoute, redirect } from '@tanstack/react-router'
import { EmailTemplatesPage, emailService } from '@/features/boilerplate/email'
...
export const Route = createFileRoute('/{-$locale}/_protected/_boilerplate/email/templates')({
  loader: async ({ context }) => {
    ...
    if (typeof window === 'undefined') {
      try {
        ...
        if (convexClient) {
          const templates = await convexClient.query(api.lib.boilerplate.email.queries.getAllTemplates, {})
