// routes/{-$locale}/_protected/_boilerplate/notifications/index.tsx

import { createFileRoute } from '@tanstack/react-router'
import { NotificationsPage, notificationService } from '@/features/boilerplate/notifications'
import { api } from '@/convex/_generated/api'
import { Loading } from '@/components/ui'
import { defaultLocale } from '@/features/boilerplate/i18n'
import { createI18nSeo } from '@/utils/seo'

export const Route = createFileRoute('/{-$locale}/_protected/_boilerplate/notifications/')({
  loader: async ({ context }) => {
    ...
    if (typeof window === 'undefined') {
      try {
        ...
        if (convexClient) {
          const notifications = await convexClient.query(api.lib.boilerplate.notifications.queries.getNotifications, {})
