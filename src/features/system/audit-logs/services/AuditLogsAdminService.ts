// src/features/boilerplate/audit-logs/services/AuditLogsAdminService.ts
...
class AuditLogsAdminService {
  ...
  getAdminAuditLogsQueryOptions(options: AuditLogListOptions) {
    ...
    return convexQuery(api.lib.boilerplate.audit_logs.admin_queries.adminGetAuditLogs, {
      options: convexOptions,
    });
  }

  getAdminAuditLogStatsQueryOptions(timeWindow?: 'day' | 'week' | 'month' | 'all') {
    return convexQuery(api.lib.boilerplate.audit_logs.admin_queries.adminGetAuditLogStats, {
      timeWindow,
    });
  }

  getAdminUserAuditLogsQueryOptions(targetUserId: Id<"userProfiles">, limit?: number) {
    return convexQuery(api.lib.boilerplate.audit_logs.admin_queries.adminGetUserAuditLogs, {
      targetUserId,
      limit,
    });
  }
  ...
  getAdminRecentActivityQueryOptions(limit?: number) {
    return convexQuery(api.lib.boilerplate.audit_logs.admin_queries.adminGetRecentActivity, {
      limit,
    });
  }
  ...
  useAdminAuditLogs(options: AuditLogListOptions) {
    ...
    return useQuery({
      ...convexQuery(api.lib.boilerplate.audit_logs.admin_queries.adminGetAuditLogs, {
        options: convexOptions,
      }),
  ...
  useAdminAuditLogStats(timeWindow?: 'day' | 'week' | 'month' | 'all'): ReturnType<typeof useQuery<AdminAuditLogStats>> {
    return useQuery({
      ...convexQuery(api.lib.boilerplate.audit_logs.admin_queries.adminGetAuditLogStats, {
        timeWindow,
      }),
  ...
  useAdminUserAuditLogs(targetUserId: Id<"userProfiles">, limit?: number) {
    return useQuery({
      ...convexQuery(api.lib.boilerplate.audit_logs.admin_queries.adminGetUserAuditLogs, {
        targetUserId,
        limit,
      }),
  ...
  useAdminRecentActivity(limit?: number) {
    return useQuery({
      ...convexQuery(api.lib.boilerplate.audit_logs.admin_queries.adminGetRecentActivity, {
        limit,
      }),
      staleTime: 30000,
    })
  ...
  useCleanupOldAuditLogs() {
    return useMutation({
      mutationFn: useConvexMutation(api.lib.boilerplate.audit_logs.mutations.cleanupOldAuditLogs),
    })
  }
  ...
  useBulkCreateAuditLogs() {
    return useMutation({
      mutationFn: useConvexMutation(api.lib.boilerplate.audit_logs.mutations.bulkCreateAuditLogs),
    })
  }
